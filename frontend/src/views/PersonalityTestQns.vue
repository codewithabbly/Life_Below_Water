<template>
  <div class="app gradient-background">
    <div class="container m-5">
      <div
        class="row m-5"
        v-for="(qn, index) in testQuestions"
        :key="index"
        :id="index"
      >
        <div class="overallBox container text-center">
          ...
          <div class="row my-1 m-md-4">
            ...
            <button
              class="col-md-4 p-4 my-3 m-md-0 questionBox"
              :class="{ active: buttons[index].turtle }"
              @click="toggleActive('turtle', index)"
              :disabled="buttons[index].dolphin || buttons[index].otter || buttons[index].penguin"
            >
              {{ qn.options.turtle }}
            </button>
            ...
            <button
              class="col-md-4 p-4 my-3 m-md-0 questionBox"
              :class="{ active: buttons[index].dolphin }"
              @click="toggleActive('dolphin', index)"
              :disabled="buttons[index].turtle || buttons[index].otter || buttons[index].penguin"
            >
              {{ qn.options.dolphin }}
            </button>
            <div class="col-md-1"></div>
          ...
          <div class="row my-1 m-md-4">
            ...
            <button
              class="col-md-4 p-4 my-3 m-md-0 questionBox"
              :class="{ active: buttons[index].otter }"
              @click="toggleActive('otter', index)"
              :disabled="buttons[index].turtle || buttons[index].dolphin || buttons[index].penguin"
            >
              {{ qn.options.otter }}
            </button>
            <div class="col-md-2"></div>
            <button
              class="col-md-4 p-4 my-3 m-md-0 questionBox"
              :class="{ active: buttons[index].penguin }"
              @click="toggleActive('penguin', index)"
              :disabled="buttons[index].turtle || buttons[index].dolphin || buttons[index].otter"
            >
              {{ qn.options.penguin }}
            </button>
            <div class="col-md-1"></div>
      ...
      <div class="row m-5 submit">
        ...
        <div class="col-md-4 submit">
          <router-link
            :to="{ name: 'personalityTestResults', params: { maxAnimal: calcResult() } }"
          >
  ...
  export default {
    ...
    data() {
      return {
        testQuestions: [
          {
            question: "Which landscape do you find most appealing?",
            options: {
              turtle: "Sandy beaches and tropical islands.",
          ...
          },
          {
            ...
            options: {
              turtle: "With a gentle and steady approach.",
          ...
          },
          {
            ...
            options: {
              turtle: "Enjoying peaceful solitude.",
          ...
          },
          {
            ...
            options: {
              turtle: "Plastic pollution and its impact on marine life.",
          ...
          },
          {
            ...
            options: {
              turtle: "Lounging on a tropical beach with a good book.",
          ...
          },
          {
            ...
            options: {
              turtle: "Taking a nap or meditating.",
          ...
          },
          {
            ...
            options: {
              turtle: "Content and at ease with the present.",
          ...
          },
          {
            ...
            options: {
              turtle: "In the waves of change, we find our true direction.",
              dolphin:
